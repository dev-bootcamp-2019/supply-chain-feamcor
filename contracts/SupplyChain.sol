...
contract SupplyChain {
    ...
    */
    ...
    modifier verifyCaller(address _address) {
        require (msg.sender == _address, "caller mismatch");
        _;
    }

    modifier paidEnough(uint _price) {
        require(msg.value >= _price, "item is more expensive");
        _;
    }
    ...
    */
    ...
    modifier sold(uint _sku) {
        require(items[_sku].state == State.Sold, "item was not sold yet");
        _;
    }

    modifier shipped(uint _sku) {
        require(items[_sku].state == State.Shipped, "item was not shipped yet");
        _;
    }
    modifier received(uint _sku) {
        require(items[_sku].state == State.Received, "item was not received yet");
        _;
    }
